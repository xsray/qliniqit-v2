...
render_fn = function() {
  ...
  const currentRate = (0, import_media_playback_rate_button.normalizePlaybackRate)(this.mediaPlaybackRate);
  const ratesSet = new Set(
    Array.from(__privateGet(this, _rates)).map((rate) => (0, import_media_playback_rate_button.normalizePlaybackRate)(Number(rate)))
  );
