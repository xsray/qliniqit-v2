...
class MediaRenditionMenu extends import_media_chrome_menu.MediaChromeMenu {
  ...
  attributeChangedCallback(attrName, oldValue, newValue) {
    ...
    if (oldValue !== newValue) {
      switch (attrName) {
        case import_constants.MediaUIAttributes.MEDIA_RENDITION_SELECTED:
          this.value = newValue != null ? newValue : "auto";
          __privateMethod(this, _render, render_fn).call(this);
          break;
        case import_constants.MediaUIAttributes.MEDIA_RENDITION_LIST:
          __privateSet(this, _renditionList, (0, import_utils.parseRenditionList)(newValue));
          __privateMethod(this, _render, render_fn).call(this);
          break;
        case import_constants.MediaUIAttributes.MEDIA_HEIGHT:
        case import_constants.MediaUIAttributes.MEDIA_WIDTH:
          __privateMethod(this, _render, render_fn).call(this);
          break;
      }
    }
  ...
  get mediaWidth() {
    return (0, import_element_utils.getNumericAttr)(this, import_constants.MediaUIAttributes.MEDIA_WIDTH);
  }
  set mediaWidth(width) {
    (0, import_element_utils.setNumericAttr)(this, import_constants.MediaUIAttributes.MEDIA_WIDTH, width);
  }
...
render_fn = function() {
  ...
  if (__privateGet(this, _prevState).mediaRenditionList === JSON.stringify(this.mediaRenditionList) && __privateGet(this, _prevState).mediaHeight === this.mediaHeight && __privateGet(this, _prevState).mediaWidth === this.mediaWidth && __privateGet(this, _prevState).isAuto === isAuto)
    return;
  ...
  if (isAuto) {
    if (selectedRendition) {
      ...
      autoText = this.formatMenuItemText(`${(0, import_i18n.t)("Auto")} (${Math.min(this.mediaWidth, this.mediaHeight)}p)`);
    }
  }
  if (!autoText) {
    autoText = this.formatMenuItemText((0, import_i18n.t)("Auto"));
  }
