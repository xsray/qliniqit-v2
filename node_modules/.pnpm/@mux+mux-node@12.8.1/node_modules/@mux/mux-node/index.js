...
class Mux extends Core.APIClient {
     ...
     */
    constructor({ baseURL = Core.readEnv('MUX_BASE_URL'), tokenId = Core.readEnv('MUX_TOKEN_ID') ?? null, tokenSecret = Core.readEnv('MUX_TOKEN_SECRET') ?? null, webhookSecret = Core.readEnv('MUX_WEBHOOK_SECRET') ?? null, jwtSigningKey = Core.readEnv('MUX_SIGNING_KEY') ?? null, jwtPrivateKey = Core.readEnv('MUX_PRIVATE_KEY') ?? null, authorizationToken = Core.readEnv('MUX_AUTHORIZATION_TOKEN') ?? null, ...opts } = {}) {
        const options = {
            tokenId,
            tokenSecret,
            webhookSecret,
