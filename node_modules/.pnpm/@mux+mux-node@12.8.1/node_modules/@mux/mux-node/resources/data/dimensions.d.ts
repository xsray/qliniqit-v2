...
export declare class Dimensions extends APIResource {
     ...
     * ```
     */
    listTraceElements(dimensionId: string, query?: DimensionListTraceElementsParams, options?: Core.RequestOptions): Core.PagePromise<DimensionValuesBasePage, DimensionValue>;
    listTraceElements(dimensionId: string, options?: Core.RequestOptions): Core.PagePromise<DimensionValuesBasePage, DimensionValue>;
    /**
...
export declare namespace Dimensions {
    export { type DimensionValue as DimensionValue, type DimensionsResponse as DimensionsResponse, DimensionValuesBasePage as DimensionValuesBasePage, type DimensionListTraceElementsParams as DimensionListTraceElementsParams, type DimensionListValuesParams as DimensionListValuesParams, };
}
